...
class ShareArticleDialog extends StatefulWidget {
  ShareArticleDialog({
    Key key,
    this.title,
  ...
  @override
  State<StatefulWidget> createState() => _ShareArticleDialogState();
}

class _ShareArticleDialogState extends State<ShareArticleDialog> {
    ...
    return Padding(
      ...
      child: Padding(
        ...
        child: AppBassTextField(
          ...
          textStyle: AppTextStyle.body(fontSize: 14, color: AppColors.lightGrey2),
