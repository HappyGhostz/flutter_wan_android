class WendaListResponseModule {
  WendaListData wendaListData;
  int errorCode;
  String errorMsg;

  WendaListResponseModule({this.wendaListData, this.errorCode, this.errorMsg});

  WendaListResponseModule.fromJson(Map<String, dynamic> json) {
    wendaListData = json['data'] != null ? WendaListData.fromJson(json['data'] as Map<String, dynamic>) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (wendaListData != null) {
      data['data'] = wendaListData.toJson();
    }
...
class WendaListData {
  ...
  WendaListData({this.curPage, this.wendas, this.offset, this.over, this.pageCount, this.size, this.total});

  WendaListData.fromJson(Map<String, dynamic> json) {
    curPage = json['curPage'] as int;
    if (json['datas'] != null) {
      wendas = <WendaModule>[];
      json['datas'].forEach((dynamic v) {
        wendas.add(WendaModule.fromJson(v as Map<String, dynamic>));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (wendas != null) {
      data['datas'] = wendas.map((v) => v.toJson()).toList();
    }
    data['offset'] = offset;
    data['over'] = over;
...
class WendaModule {
  ...
  WendaModule.fromJson(Map<String, dynamic> json) {
