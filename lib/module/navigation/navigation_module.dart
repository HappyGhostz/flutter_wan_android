...
class NavigationModule {
  ...
  NavigationModule({this.navigationData, this.errorCode, this.errorMsg});

  NavigationModule.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      navigationData = <NavigationData>[];
      json['data'].forEach((dynamic v) {
        navigationData.add(NavigationData.fromJson(v as Map<String, dynamic>));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (navigationData != null) {
      data['data'] = navigationData.map((v) => v.toJson()).toList();
    }
