class ProjectListResponseModule {
  ProjectListData projectListData;
  int errorCode;
  String errorMsg;

  ProjectListResponseModule({this.projectListData, this.errorCode, this.errorMsg});

  ProjectListResponseModule.fromJson(Map<String, dynamic> json) {
    projectListData = json['data'] != null ? ProjectListData.fromJson(json['data'] as Map<String, dynamic>) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (projectListData != null) {
      data['data'] = projectListData.toJson();
    }
...
class ProjectListData {
  ...
  ProjectListData({this.curPage, this.projects, this.offset, this.over, this.pageCount, this.size, this.total});
  ...
  ProjectListData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['datas'] != null) {
      ...
      json['datas'].forEach((dynamic v) {
        projects.add(Projects.fromJson(v as Map<String, dynamic>));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (projects != null) {
      data['datas'] = projects.map((v) => v.toJson()).toList();
    }
    data['offset'] = offset;
    data['over'] = over;
